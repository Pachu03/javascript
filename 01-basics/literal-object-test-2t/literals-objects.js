...
export const addSpanishNacionalityAsNewProperty = () => {
  return (person.nacionalty = "Spanish");
};
...
export const getLastPrincipalOfDirector = () => {
  return movie.director.notableFilmography[
    movie.director.notableFilmography.length - 1
  ];
};
...
export const getDescriptionOfGandalf = () => {
  ...
  return movie.characters.find((character) => character.name === "Gandalf")
    .description;
};
...
export const getRealOfAragorn = () => {
  ...
  return movie.characters.find((character) => character.name === "Aragorn")
    .actor;
};
...
export const getIndexOfFantasaiValue = () => {
  return Object.values(movie).indexOf(movie.genre);
};
